...
<body id="home" class="bg-night font-exo text-white">
    <nav class="bg-night h-20 w-full flex fixed rounded-b-xl">
        <div class="container mx-80 flex justify-between items-center">
            ...
            <div class="flex gap-10">
                ...
                <a href="#catalog" class="font-medium hover:text-blue transition duration-500">Catalog</a>
    ...
    <main class="py-20">
        <!-- About -->
        <div id="about" class="mx-80 py-10">
